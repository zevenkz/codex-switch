...
//!
//! Parses codexswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a codexswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "codexswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'codexswitch', got '{scheme}'"
        )));
    }
